...
//        return medicoRepository.findAll(paginacion).map(DatosListadoMedico::new);
    ...
    // DELETE LOGICO, INACTIVAR EL REGISTRO.
    @DeleteMapping("/{id}")
    @Transactional
...
//    DELETE DIRECTO EN BASE DE DATOD
